  ...
  */
  ...
  Route::group(['middleware' => 'auth'], function () {
    ...
    /*  Route::group(['middleware' => ['role:owner|desarrollo|cuentas|coordinador']], function() {

  });*/

  Route::get('/editar_ot/{id}', ['middleware' => ['permission:editar_ots'], 'uses' => 'OtController@edit']);
  Route::get('/ver_ot/{id}', ['middleware' => ['permission:ver_ots'], 'uses' => 'OtController@show']);

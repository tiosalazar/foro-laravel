<template>
	<div class="tarea  table-responsive">
	  <form method="POST" id="search-form" class="form-inline" role="form">
        ...
        <table class="table  table-striped table-hover table-responsive datatable-foro table-bordered dataTable no-footer" role="grid" id="tabla_historico_equipo" cellspacing="0" width="100%">
		  <thead>
		        <tr>
...
<script>
	...
	module.exports={
		...
		created: function(){
			...
			if ( (typeof(this.entidad) == 'undefined') || this.entidad=="" ) {
				this.entidad = 1;
			}
		...
		mounted(){
			let that = this;
			var oTable = $('#tabla_historico_equipo').DataTable({
				...
				// ajax: "/api/v1/tareas",
				ajax: {
					url: window._baseURL+"/hitorico_equipo/"+that.entidad,
					data: function (d) {
				...
				columnDefs: [
					{
						...
						"data": null,
						   "render": function(data, type, full) { // Devuelve el contenido personalizado
						  	 return (full.tipo_de_entidad==1)? 'Usuario' : 'Area';
						     }
					}
					// {
					// 	"targets": [6],

              ...
              <div class="col-sm-6 columna2">
                ...
                <div class="form-group same-height">
                 ...
                 <div class="form-group same-height">
                  ...
                  <div class="" v-if="(rol_actual =='owner' && tarea_info.estados_id != '1' ) || (rol_actual =='desarrollo' && tarea_info.estados_id != '1') || (id_usuario_actual == tarea_info.encargado_id && tarea_info.estados_id != '1' && tarea_info.estados_id != '2' && tarea_info.estados_id != '20' ) || (rol_actual =='coordinador' && tarea_info.estados_id == '2')|| (rol_actual =='coordinador' && tarea_info.estados_id == '20')">

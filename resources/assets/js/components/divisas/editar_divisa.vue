<template>
  <div>
    <form class="row" name="agregar_fase" id="agregar_cliente">
      ...
      <div class="col-xs-12 col-md-12">
        <button type="button" v-on:click="editDivisa" class="btn btn-flat btn-success pull-right">Editar</button>
        <button type="button" v-on:click="showModal(divisa)" class="btn btn-flat btn-danger ">Borrar</button>
      </div>
      <!-- </div> -->
    </form>
    <!-- /.row -->

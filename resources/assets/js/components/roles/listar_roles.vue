...
<script>
  ...
  methods:{
    ...
    updaterol:function(){
      ...
      let idmodal=this.id_rol_edit;
      let nombremodal=this.nombre_rol_edit.nombre;
      let display_namemodal=this.nombre_rol_edit.display_name;
      let descriptionmodal=this.nombre_rol_edit.description;

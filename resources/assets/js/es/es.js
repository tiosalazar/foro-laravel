export default {
    ...
    alpha_dash: (field) => `El campo ${field} sólo debe contener letras, números y guiones.`,
    alpha_num: (field) => `El campo ${field} sólo debe contener letras y números.`,
    alpha_spaces: (field) => `El campo ${field} sólo debe contener caracteres alfabéticos con espacios.`,
    alpha: (field) => `El campo ${field} sólo debe contener letras.`,
    ...
    numeric: (field) => `El campo ${field} debe contener sólo caracteres númericos.`,

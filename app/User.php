...
class User extends Authenticatable
{
  ...
  */
  protected $fillable = [
    'nombre', 'apellido', 'cargo', 'telefono', 'email','api_token','horas_disponible','horas_gastadas', 'password', 'roles_id', 'areas_id','estado',
    'fecha_nacimiento','img_perfil','access_token'
  ];
